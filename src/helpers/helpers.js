    ...
    embeds: [
      new EmbedBuilder()
        ...
        .setDescription(``
          ...
          + `\n`
          + `:fire: [Purchase ${Manager.config.brand.name} Premium](${self.instance.brand.brand.url}/pricing?utm_source=discord-beta-acceptance&utm_medium=discord&utm_campaign=beta-acceptance)\n`
        )
    ]
  })
};
