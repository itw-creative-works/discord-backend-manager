      ...
      try {
        ...
        embeds: [
          ...
          .setDescription(''
            ...
            + `\nYou can buy ${helpers.getPrettyRole('premium')} [here](${instance.brand.brand.url}/pricing) OR be active in the Discord server to earn ${helpers.getPrettyRole('active')} manually.`
          )
        ],
      });
		} else {
